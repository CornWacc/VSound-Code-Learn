 ...
 * */
@Service
public class CodeParameterStrategyFactory extends AbstractCUDFactory<BaseCUDInterface, CodeParameterCUDOrder> {

    @Autowired
    private SpringBeanUtils springBeanUtils;

    @Override
    public BaseCUDInterface createStrategy(CodeParameterCUDOrder order) {
